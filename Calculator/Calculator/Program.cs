...
namespace Calculator
{
    internal class Program
    {
        ...
        static BigInteger CalculatingRealNums(BigInteger numberOne, char sum, char minus, char multiply, char division, char charInput, BigInteger numberTwo, BigInteger result)
        {
            if (charInput == sum)
            {
                result = numberOne + numberTwo;
        ...
        static BigInteger CheckNumIfZero(char division, char charInput, BigInteger numberTwo)
        {
            if (numberTwo == 0 && charInput == division)
            {
                ...
                numberTwo = BigInteger.Parse(Console.ReadLine());
